...
class BO_Sequential_Base(object):
    ...
    def __init__(self, gp_params, func_params, acq_params, verbose=1):
        ...
        self.gp=self.select_gp_model(gp_params)
    ...
    def select_gp_model(self,gp_params):
    
        if self.acq_params['acq_func']['surrogate']=='gp':
    ...
    def optimize_gp_hyperparameter(self,mygp=None,gp_params=None):
        ...
        mygp=self.select_gp_model(gp_params)
    ...
    def augment_the_new_data(self,x_max):
        ...
        try: 
            ...
            x_mu_max,max_GPmean=acq_max_with_name(gp=self.gp,scalebounds=self.scalebounds,acq_name="mu",IsReturnY=True)
            _,sig_at_max_GPmean=self.gp.predict(x_mu_max)
            _,sig_at_chosen_point=self.gp.predict(x_max)
        ...
        self.maxGPmean=np.append(self.maxGPmean, max_GPmean)
        self.sig_at_max_GPmean=sig_at_max_GPmean
        self.sig_at_chosenpoint=sig_at_chosen_point
