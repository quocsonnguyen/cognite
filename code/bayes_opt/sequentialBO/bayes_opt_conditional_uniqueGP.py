...
# using GP with unique locations
class BayesOpt_Cond_UniqueGP(BO_Sequential_Base):
    ...
    def __init__(self, gp_params, func_params, acq_params, verbose=1):
        ...
        super(BayesOpt_Cond_UniqueGP, self).__init__(gp_params, func_params, acq_params, verbose)
    ...
    def init_with_data(self, init_X,init_Y):
        ...
        """
        super(BayesOpt_Cond_UniqueGP, self).init_with_data(init_X,init_Y)       
    ...
    def maximize_condition(self,mycondition):
        ...
        if self.acq['name']=='random':
            ...
            super(BayesOpt_Cond_UniqueGP, self).generate_random_point()
            return
        ...
        super(BayesOpt_Cond_UniqueGP, self).augment_the_new_data(x_max)
