...
def print_result_sequential(bo,myfunction,Score,acq_type,toolbox='PradaBO'):
    ...
    if 'model' not in acq_type or acq_type['model'] is None:
        strFile="{:s}_{:d}_{:s}_{:s}.pickle".format(myfunction.name,myfunction.input_dim,
             acq_type['name'],acq_type['surrogate'])
    else:
        strFile="{:s}_{:d}_{:s}_{:s}_{:s}.pickle".format(myfunction.name,myfunction.input_dim,
                 acq_type['name'],acq_type['surrogate'],acq_type['model'])
